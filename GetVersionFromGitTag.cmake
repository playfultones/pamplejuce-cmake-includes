...
# the GIT_FOUND and GIT_EXECUTABLE variables. Git is required.
#
...
#
# Based on work by Nuno Fachada (public domain)

if (NOT GIT_FOUND)
	message(FATAL_ERROR "Git is required for version detection")
endif()
...
if (NOT GIT_DESCRIBE_RESULT EQUAL 0)
	message(FATAL_ERROR "No git tags found. Create an initial version tag (e.g., 'git tag v0.0.0')")
endif()
...
# Write VERSION file (used by build scripts)
file(WRITE ${CMAKE_SOURCE_DIR}/VERSION "${${PROJECT_NAME}_VERSION}\n")
